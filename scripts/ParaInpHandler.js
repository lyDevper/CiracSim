class ParaInpHandler {
    ...
    */
    ...
    constructor(inputId, resetId, state, defaultVal, numStep=0.1, decPlace=2) {
    ...
    setValue(value) { // value: Number
        ...
        this.input.value = value.toFixed(this.decPlace);
    }
    ...
    static buildHandlers() {
        ...
        this.cmpst_r_handler = new ParaInpHandler('inp_cmpst_r', 'reset_cmpst_r',
                        StatePara.state_cmpst_r, DefaultPara.cmpst_r, 0.001, 4);

        this.cmpst_z_robot_handler = new ParaInpHandler('inp_cmpst_z_robot', 'reset_cmpst_z_robot',
                        StatePara.state_cmpst_z_robot, DefaultPara.cmpst_z_robot, 0.01, 4);
